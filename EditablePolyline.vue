<template>
    <div>
        <l-polyline
            ...
            :color="editablePolylinelatlngsOptions.line.color"
        >
        </l-polyline>
        <l-marker
            v-if="zoom >= editablePolylinelatlngsOptions.displayZoom"
            ...
            <l-icon
                ...
                :icon-size="editablePolylinelatlngsOptions.iconSize"
                :icon-anchor="editablePolylinelatlngsOptions.iconAnchor"
            >
...
export default {
    ...
    data() {
        return {
            ...
            editablePolylinelatlngsOptions: {
                line: {
                    color: 'red'
                },
                displayZoom: 6,
